...
const MarketPage = () => {
  const test = [
    ...
    },
    {
      ...
      bio:
        'I am a third-year student pursuing a specialist in Biodiversity + Conservation and a minor in Music & Culture. Music has played a significant role in my life since I was very young but I’ve only recently become interested in composing. I’m mainly self-taught and have been enjoying learning to write for small ensemble and concert band. Endurance is my first piece for flute quintet. ',
      desc:
    ...
    },
    {
      ...
      bio:
        '2nd year UTSC student double-majoring Environmental Science and Environmental Studies. Experienced flutist. Rookie composer with interests in all sorts of genres, from EDM, R&B to orchestral and classical music. ',
      desc:
    ...
    },
    {
      ...
      bio:
        'Grant Craven (November 23, 1995), known professionally as Rowin Roberts or under the moniker “November”, is a Canadian film and game composer, pianist, and guitarist. He is fascinated by music theory and the neuropsychology of music, spending the time he isn’t composing by reading textbooks and academic research articles. This, naturally, excludes him from many social events.',
      desc:
        'Although it may get hard, there is always someone who has your back. You never need to push yourself farther for them. They would much rather you to push yourself for you.',
      links: [
        {
          type: 'Email',
    ...
    <Layout>
      ...
      <Flex>
        ...
        <Link
          marginLeft="15px"
          target="_blank"
          href="https://www.instagram.com/soundwaves_utsc/"
        >
          Instagram
        </Link>
        <Link
          marginLeft="15px"
          target="_blank"
          href="https://discord.gg/5rWERtXe7z"
        >
          Discord
        </Link>
      </Flex>
      ...
      <Heading
        ...
        marginBottom="20px"
      >
        SoundWaves is UTSC’s newest and only music composition club. We meet
        online every Tuesday 1-2pm on zoom, and hopefully soon in person. At
        SoundWaves we write or contribute to new works of music every week. Our
        meetings are centered around the sharing of our weekly assigned projects
        and other collaborations in music. We are open to anyone who is
        interested in music composition and most meetings are free for drop in.
        To become a member of SoundWaves, please join our discord and introduce
        yourself there!
      </Heading>
      ...
      <Heading
        ...
        marginBottom="40px"
      >
        This year, SoundWaves and ARTSIDEOUT have come together to share music
        relating to the theme of Endurance. Feel free to check out all the
        composers and their bios down below. You can listen to the playlist of
        Endurance in the media player.
      </Heading>
